      ...
      <div className="relative w-full flex justify-center items-center px-3 py-4">
        <Link href="#Home" className="flex-1">
          <div className="flex items-center hover:cursor-pointer gap-6">
            <Image
              ...
              width={60}
              height={60}
              className="hover:scale-110 hover:rotate-15 hover:cursor-pointer"
            />
            <div>
              <h1 className="text-3xl font-extrabold text-gradient  tracking-tight hover: cursor-pointer">
                {" "}
                PiBi Tech
              </h1>
              <h1 className="text-xs text-green-400 tracking-tight hover:cursor-pointer">
        ...
        <div className="hidden xl:flex z-[1000] cursor-pointer">
          <div className="flex gap-8 font-semibold justify-center items-center text-xl ">
            <Link
              href="#services"
              className="pl-20 hover:text-blue-400 hover:cursor-pointer"
            >
              Services
            </Link>
            <Link
            ...
            <Link
              href="#contactus"
              className="pr-20  hover:text-blue-400 hover:cursor-pointer"
            >
              Contact Us
            </Link>
            <Link href="#contactUs">
              <button className="bg-gradient-to-r w-full my-4 text-center from-blue-700 to-purple-600 rounded-full py-2 px-5 opacity-90 hover:opacity-100 hover:cursor-pointer text-xl font-semibold text-white">
                Get Pricing
              </button>
            </Link>
          </div>
